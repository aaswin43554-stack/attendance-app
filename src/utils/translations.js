export const translations = {
    en: {
        ...
        otpVerify: "📱 Send OTP to phone",
        sendOtpTo: "Send OTP to {phone}",
        enterLastPassword: "Enter Last Password",
        verifying: "Verifying...",
        verify: "Verify",
        enterOtp: "Enter 4-Digit OTP",
        otpMockHint: "Mock: Enter any 4 digits to proceed",
        ...
        otpLengthError: "Please enter a 4-digit OTP.",
    ...
    la: {
        ...
        otpVerify: "📱 ສົ່ງ OTP ໄປຫາເບີໂທລະສັບ",
        sendOtpTo: "ສົ່ງ OTP ໄປຫາ {phone}",
        enterLastPassword: "ປ້ອນລະຫັດຜ່ານຫຼ້າສຸດ",
        verifying: "ກຳລັງຢືນຢັນ...",
        verify: "ຢືນຢັນ",
        enterOtp: "ປ້ອນລະຫັດ OTP 4 ຫຼັກ",
        otpMockHint: "Mock: ປ້ອນເລກ 4 ຫຼັກໃດກໍ່ໄດ້ເພື່ອສືບຕໍ່",
        ...
        otpSent: "ສົ່ງ OTP ໄປຫາເບີໂທລະສັບທີ່ລົງທະບຽນແລ້ວ",
        otpLengthError: "ກະລຸນາປ້ອນ OTP 4 ຫຼັກ",
